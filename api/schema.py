...
class MeterUpdate(relay.ClientIDMutation):
     ...
     def mutate_and_get_payload(cls, root, info, **kwargs):
        ...
        meter.meter_type = kwargs['meter_type']
...
class Query(graphene.ObjectType):
    ...
    meter = DjangoFilterConnectionField(MeterTy, description="""
    ...
    asset_account_link = DjangoFilterConnectionField(AccountAssetLinkType, description="""
    ...
    consumption = DjangoFilterConnectionField(ConsumptionType, description="""
    ...
    """ Rate Queries """
    rate = DjangoFilterConnectionField(RateType, description="""
